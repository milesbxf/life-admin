...
3. For each document, spawn the `paperless-processor` agent with the document ID
4. If the document has no Summary set, also spawn the `paperless-summariser` agent for it
5. Report back a summary of what was processed and what was applied to each document
